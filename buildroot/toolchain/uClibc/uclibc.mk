...
# Chmod needed for source code control systems where the source file is read-only
$(UCLIBC_DIR)/.config: $(UCLIBC_DIR)/.unpacked $(UCLIBC_CONFIG_FILE)
	cp -f $(UCLIBC_CONFIG_FILE) $(UCLIBC_DIR)/.config
	chmod u+w $(UCLIBC_DIR)/.config
...
$(STAGING_DIR)/lib/libc.a: $(UCLIBC_DIR)/lib/libc.a
	...
	cp -pLR $(LINUX_HEADERS_DIR)/include/net80211 $(STAGING_DIR)/include/
