...
# This target must be invoked when target filing system is cleaned (i.e. deleted) as
# it tells the gcc rule that its libraries need to be recopied.
gcc_force_library_copy:
	rm -f $(GCC_BUILD_DIR2)/.libs_installed
