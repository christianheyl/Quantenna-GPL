...
$(BRIDGE_BUILD_DIR)/.unpacked: $(DL_DIR)/$(BRIDGE_SOURCE)
	...
	patch -g0 -p1 -d $(BRIDGE_BUILD_DIR) < package/bridge/bridge.patch
	patch -g0 -p1 -d $(BRIDGE_BUILD_DIR) < package/bridge/bridge-add-igmp-snoop.patch
	patch -g0 -p1 -d $(BRIDGE_BUILD_DIR) < package/bridge/bridge_ssdp.patch
	patch -g0 -p1 -d $(BRIDGE_BUILD_DIR) < package/bridge/bridge_mc_debug.patch
