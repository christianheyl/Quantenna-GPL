...
#new d/l site
IPSEC_TOOLS_SITE=ftp://ftp.netbsd.org/pub/NetBSD/misc/ipsec-tools/0.7/
...
$(IPSEC_TOOLS_DIR)/.configured: $(IPSEC_TOOLS_DIR)/.patched
	( cd $(IPSEC_TOOLS_DIR); rm -rf config.cache; \
	  ...
	  --enable-shared \
	  --enable-static \
	  --with-kernel-headers=$(LINUX_HEADERS_DIR) \
...
ipsec-tools: openssl flex flex-host $(IPSEC_TOOLS_PROGS)
