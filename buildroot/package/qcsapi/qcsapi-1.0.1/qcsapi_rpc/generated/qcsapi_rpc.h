...
struct __rpc_qcsapi_node_txrx_airtime {
...
typedef struct __rpc_qcsapi_node_txrx_airtime __rpc_qcsapi_node_txrx_airtime;
...
struct qcsapi_wifi_get_threshold_of_neighborhood_type_rpcdata {
	__rpc_string *ifname;
	uint32_t type;
	uint32_t *threshold;
	int return_code;
};
typedef struct qcsapi_wifi_get_threshold_of_neighborhood_type_rpcdata qcsapi_wifi_get_threshold_of_neighborhood_type_rpcdata;
...
struct qcsapi_wifi_node_get_txrx_airtime_rpcdata {
	__rpc_string *ifname;
	uint32_t node_index;
	__rpc_qcsapi_node_txrx_airtime *node_txrx_airtime;
	int return_code;
};
typedef struct qcsapi_wifi_node_get_txrx_airtime_rpcdata qcsapi_wifi_node_get_txrx_airtime_rpcdata;

struct qcsapi_wifi_get_txrx_airtime_rpcdata {
	__rpc_string *ifname;
	__rpc_string *buffer;
	int return_code;
};
typedef struct qcsapi_wifi_get_txrx_airtime_rpcdata qcsapi_wifi_get_txrx_airtime_rpcdata;
...
struct qcsapi_wifi_get_tx_max_amsdu_rpcdata {
	__rpc_string *ifname;
	int *max_len;
	int return_code;
};
typedef struct qcsapi_wifi_get_tx_max_amsdu_rpcdata qcsapi_wifi_get_tx_max_amsdu_rpcdata;

struct qcsapi_wifi_set_tx_max_amsdu_rpcdata {
	__rpc_string *ifname;
	int max_len;
	int return_code;
};
typedef struct qcsapi_wifi_set_tx_max_amsdu_rpcdata qcsapi_wifi_set_tx_max_amsdu_rpcdata;
...
struct qcsapi_set_remote_logging_rpcdata {
	int action_type;
	u_int ipaddr;
	int return_code;
};
typedef struct qcsapi_set_remote_logging_rpcdata qcsapi_set_remote_logging_rpcdata;

struct qcsapi_set_console_rpcdata {
	int action_type;
	int return_code;
};
typedef struct qcsapi_set_console_rpcdata qcsapi_set_console_rpcdata;

struct qcsapi_do_system_action_rpcdata {
	__rpc_string *action;
	int return_code;
};
typedef struct qcsapi_do_system_action_rpcdata qcsapi_do_system_action_rpcdata;
...
struct qcsapi_wifi_set_br_isolate_rpcdata {
	int cmd;
	uint32_t arg;
	int return_code;
};
typedef struct qcsapi_wifi_set_br_isolate_rpcdata qcsapi_wifi_set_br_isolate_rpcdata;

struct qcsapi_wifi_get_br_isolate_rpcdata {
	uint32_t *result;
	int return_code;
};
typedef struct qcsapi_wifi_get_br_isolate_rpcdata qcsapi_wifi_get_br_isolate_rpcdata;
...
extern  enum clnt_stat qcsapi_wifi_get_parameter_remote_1(qcsapi_wifi_get_parameter_rpcdata *, qcsapi_wifi_get_parameter_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_get_parameter_remote_1_svc(qcsapi_wifi_get_parameter_rpcdata *, qcsapi_wifi_get_parameter_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_SET_PARAMETER_REMOTE 7011
extern  enum clnt_stat qcsapi_wifi_set_parameter_remote_1(qcsapi_wifi_set_parameter_rpcdata *, qcsapi_wifi_set_parameter_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_set_parameter_remote_1_svc(qcsapi_wifi_set_parameter_rpcdata *, qcsapi_wifi_set_parameter_rpcdata *, struct svc_req *);
...
#define QCSAPI_WIFI_GET_THRESHOLD_OF_NEIGHBORHOOD_TYPE_REMOTE 6952
extern  enum clnt_stat qcsapi_wifi_get_threshold_of_neighborhood_type_remote_1(qcsapi_wifi_get_threshold_of_neighborhood_type_rpcdata *, qcsapi_wifi_get_threshold_of_neighborhood_type_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_get_threshold_of_neighborhood_type_remote_1_svc(qcsapi_wifi_get_threshold_of_neighborhood_type_rpcdata *, qcsapi_wifi_get_threshold_of_neighborhood_type_rpcdata *, struct svc_req *);
...
#define QCSAPI_WIFI_NODE_GET_TXRX_AIRTIME_REMOTE 6551
extern  enum clnt_stat qcsapi_wifi_node_get_txrx_airtime_remote_1(qcsapi_wifi_node_get_txrx_airtime_rpcdata *, qcsapi_wifi_node_get_txrx_airtime_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_node_get_txrx_airtime_remote_1_svc(qcsapi_wifi_node_get_txrx_airtime_rpcdata *, qcsapi_wifi_node_get_txrx_airtime_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_GET_TXRX_AIRTIME_REMOTE 6561
extern  enum clnt_stat qcsapi_wifi_get_txrx_airtime_remote_1(qcsapi_wifi_get_txrx_airtime_rpcdata *, qcsapi_wifi_get_txrx_airtime_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_get_txrx_airtime_remote_1_svc(qcsapi_wifi_get_txrx_airtime_rpcdata *, qcsapi_wifi_get_txrx_airtime_rpcdata *, struct svc_req *);
...
extern  enum clnt_stat qcsapi_wifi_is_weather_channel_remote_1(qcsapi_wifi_is_weather_channel_rpcdata *, qcsapi_wifi_is_weather_channel_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_is_weather_channel_remote_1_svc(qcsapi_wifi_is_weather_channel_rpcdata *, qcsapi_wifi_is_weather_channel_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_GET_TX_MAX_AMSDU_REMOTE 7191
extern  enum clnt_stat qcsapi_wifi_get_tx_max_amsdu_remote_1(qcsapi_wifi_get_tx_max_amsdu_rpcdata *, qcsapi_wifi_get_tx_max_amsdu_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_get_tx_max_amsdu_remote_1_svc(qcsapi_wifi_get_tx_max_amsdu_rpcdata *, qcsapi_wifi_get_tx_max_amsdu_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_SET_TX_MAX_AMSDU_REMOTE 7201
extern  enum clnt_stat qcsapi_wifi_set_tx_max_amsdu_remote_1(qcsapi_wifi_set_tx_max_amsdu_rpcdata *, qcsapi_wifi_set_tx_max_amsdu_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_set_tx_max_amsdu_remote_1_svc(qcsapi_wifi_set_tx_max_amsdu_rpcdata *, qcsapi_wifi_set_tx_max_amsdu_rpcdata *, struct svc_req *);
...
#define QCSAPI_SET_REMOTE_LOGGING_REMOTE 6991
extern  enum clnt_stat qcsapi_set_remote_logging_remote_1(qcsapi_set_remote_logging_rpcdata *, qcsapi_set_remote_logging_rpcdata *, CLIENT *);
extern  bool_t qcsapi_set_remote_logging_remote_1_svc(qcsapi_set_remote_logging_rpcdata *, qcsapi_set_remote_logging_rpcdata *, struct svc_req *);
#define QCSAPI_SET_CONSOLE_REMOTE 7061
extern  enum clnt_stat qcsapi_set_console_remote_1(qcsapi_set_console_rpcdata *, qcsapi_set_console_rpcdata *, CLIENT *);
extern  bool_t qcsapi_set_console_remote_1_svc(qcsapi_set_console_rpcdata *, qcsapi_set_console_rpcdata *, struct svc_req *);
#define QCSAPI_DO_SYSTEM_ACTION_REMOTE 6981
extern  enum clnt_stat qcsapi_do_system_action_remote_1(qcsapi_do_system_action_rpcdata *, qcsapi_do_system_action_rpcdata *, CLIENT *);
extern  bool_t qcsapi_do_system_action_remote_1_svc(qcsapi_do_system_action_rpcdata *, qcsapi_do_system_action_rpcdata *, struct svc_req *);
...
#define QCSAPI_WIFI_SET_BR_ISOLATE_REMOTE 7031
extern  enum clnt_stat qcsapi_wifi_set_br_isolate_remote_1(qcsapi_wifi_set_br_isolate_rpcdata *, qcsapi_wifi_set_br_isolate_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_set_br_isolate_remote_1_svc(qcsapi_wifi_set_br_isolate_rpcdata *, qcsapi_wifi_set_br_isolate_rpcdata *, struct svc_req *);
#define QCSAPI_WIFI_GET_BR_ISOLATE_REMOTE 7041
extern  enum clnt_stat qcsapi_wifi_get_br_isolate_remote_1(qcsapi_wifi_get_br_isolate_rpcdata *, qcsapi_wifi_get_br_isolate_rpcdata *, CLIENT *);
extern  bool_t qcsapi_wifi_get_br_isolate_remote_1_svc(qcsapi_wifi_get_br_isolate_rpcdata *, qcsapi_wifi_get_br_isolate_rpcdata *, struct svc_req *);
...
#define QCSAPI_WIFI_GET_PARAMETER_REMOTE 7001
extern  enum clnt_stat qcsapi_wifi_get_parameter_remote_1();
extern  bool_t qcsapi_wifi_get_parameter_remote_1_svc();
#define QCSAPI_WIFI_SET_PARAMETER_REMOTE 7011
extern  enum clnt_stat qcsapi_wifi_set_parameter_remote_1();
extern  bool_t qcsapi_wifi_set_parameter_remote_1_svc();
#define QCSAPI_SSID_CREATE_SSID_REMOTE 2151
...
#define QCSAPI_WIFI_GET_THRESHOLD_OF_NEIGHBORHOOD_TYPE_REMOTE 6952
extern  enum clnt_stat qcsapi_wifi_get_threshold_of_neighborhood_type_remote_1();
extern  bool_t qcsapi_wifi_get_threshold_of_neighborhood_type_remote_1_svc();
#define QCSAPI_WIFI_GET_NEIGHBORHOOD_TYPE_REMOTE 6961
...
#define QCSAPI_WIFI_NODE_GET_TXRX_AIRTIME_REMOTE 6551
extern  enum clnt_stat qcsapi_wifi_node_get_txrx_airtime_remote_1();
extern  bool_t qcsapi_wifi_node_get_txrx_airtime_remote_1_svc();
#define QCSAPI_WIFI_GET_TXRX_AIRTIME_REMOTE 6561
extern  enum clnt_stat qcsapi_wifi_get_txrx_airtime_remote_1();
extern  bool_t qcsapi_wifi_get_txrx_airtime_remote_1_svc();
#define QCSAPI_WIFI_SET_MAX_BCAST_PPS_REMOTE 6781
extern  enum clnt_stat qcsapi_wifi_set_max_bcast_pps_remote_1();
extern  bool_t qcsapi_wifi_set_max_bcast_pps_remote_1_svc();
#define QCSAPI_WIFI_IS_WEATHER_CHANNEL_REMOTE 7021
extern  enum clnt_stat qcsapi_wifi_is_weather_channel_remote_1();
extern  bool_t qcsapi_wifi_is_weather_channel_remote_1_svc();
#define QCSAPI_WIFI_GET_TX_MAX_AMSDU_REMOTE 7191
extern  enum clnt_stat qcsapi_wifi_get_tx_max_amsdu_remote_1();
extern  bool_t qcsapi_wifi_get_tx_max_amsdu_remote_1_svc();
#define QCSAPI_WIFI_SET_TX_MAX_AMSDU_REMOTE 7201
extern  enum clnt_stat qcsapi_wifi_set_tx_max_amsdu_remote_1();
extern  bool_t qcsapi_wifi_set_tx_max_amsdu_remote_1_svc();
#define QCSAPI_GET_TEMPERATURE_INFO_REMOTE 3892
...
#define QCSAPI_SET_REMOTE_LOGGING_REMOTE 6991
extern  enum clnt_stat qcsapi_set_remote_logging_remote_1();
extern  bool_t qcsapi_set_remote_logging_remote_1_svc();
#define QCSAPI_SET_CONSOLE_REMOTE 7061
extern  enum clnt_stat qcsapi_set_console_remote_1();
extern  bool_t qcsapi_set_console_remote_1_svc();
#define QCSAPI_DO_SYSTEM_ACTION_REMOTE 6981
extern  enum clnt_stat qcsapi_do_system_action_remote_1();
extern  bool_t qcsapi_do_system_action_remote_1_svc();
#define QCSAPI_WIFI_SET_MAX_BOOT_CAC_DURATION_REMOTE 6851
...
#define QCSAPI_WIFI_SET_BR_ISOLATE_REMOTE 7031
extern  enum clnt_stat qcsapi_wifi_set_br_isolate_remote_1();
extern  bool_t qcsapi_wifi_set_br_isolate_remote_1_svc();
#define QCSAPI_WIFI_GET_BR_ISOLATE_REMOTE 7041
extern  enum clnt_stat qcsapi_wifi_get_br_isolate_remote_1();
extern  bool_t qcsapi_wifi_get_br_isolate_remote_1_svc();
...
extern  bool_t xdr___rpc_qcsapi_node_txrx_airtime (XDR *, __rpc_qcsapi_node_txrx_airtime*);
...
extern  bool_t xdr_qcsapi_wifi_get_threshold_of_neighborhood_type_rpcdata (XDR *, qcsapi_wifi_get_threshold_of_neighborhood_type_rpcdata*);
...
extern  bool_t xdr_qcsapi_wifi_node_get_txrx_airtime_rpcdata (XDR *, qcsapi_wifi_node_get_txrx_airtime_rpcdata*);
extern  bool_t xdr_qcsapi_wifi_get_txrx_airtime_rpcdata (XDR *, qcsapi_wifi_get_txrx_airtime_rpcdata*);
...
extern  bool_t xdr_qcsapi_wifi_get_tx_max_amsdu_rpcdata (XDR *, qcsapi_wifi_get_tx_max_amsdu_rpcdata*);
extern  bool_t xdr_qcsapi_wifi_set_tx_max_amsdu_rpcdata (XDR *, qcsapi_wifi_set_tx_max_amsdu_rpcdata*);
...
extern  bool_t xdr_qcsapi_set_remote_logging_rpcdata (XDR *, qcsapi_set_remote_logging_rpcdata*);
extern  bool_t xdr_qcsapi_set_console_rpcdata (XDR *, qcsapi_set_console_rpcdata*);
extern  bool_t xdr_qcsapi_do_system_action_rpcdata (XDR *, qcsapi_do_system_action_rpcdata*);
extern  bool_t xdr_qcsapi_wifi_set_max_boot_cac_duration_rpcdata (XDR *, qcsapi_wifi_set_max_boot_cac_duration_rpcdata*);
extern  bool_t xdr_qcsapi_wifi_set_br_isolate_rpcdata (XDR *, qcsapi_wifi_set_br_isolate_rpcdata*);
extern  bool_t xdr_qcsapi_wifi_get_br_isolate_rpcdata (XDR *, qcsapi_wifi_get_br_isolate_rpcdata*);
...
extern bool_t xdr___rpc_qcsapi_node_txrx_airtime ();
...
extern bool_t xdr_qcsapi_wifi_get_threshold_of_neighborhood_type_rpcdata ();
...
extern bool_t xdr_qcsapi_wifi_node_get_txrx_airtime_rpcdata ();
extern bool_t xdr_qcsapi_wifi_get_txrx_airtime_rpcdata ();
extern bool_t xdr_qcsapi_wifi_set_max_bcast_pps_rpcdata ();
extern bool_t xdr_qcsapi_wifi_is_weather_channel_rpcdata ();
extern bool_t xdr_qcsapi_wifi_get_tx_max_amsdu_rpcdata ();
extern bool_t xdr_qcsapi_wifi_set_tx_max_amsdu_rpcdata ();
...
extern bool_t xdr_qcsapi_set_remote_logging_rpcdata ();
extern bool_t xdr_qcsapi_set_console_rpcdata ();
extern bool_t xdr_qcsapi_do_system_action_rpcdata ();
extern bool_t xdr_qcsapi_wifi_set_max_boot_cac_duration_rpcdata ();
extern bool_t xdr_qcsapi_wifi_set_br_isolate_rpcdata ();
extern bool_t xdr_qcsapi_wifi_get_br_isolate_rpcdata ();
