...
#define WPS_AUTH_TYPES_QTN (WPS_AUTH_OPEN | WPS_AUTH_WPAPSK | WPS_AUTH_WPA2PSK)
...
#define WPS_ENCR_TYPES (WPS_ENCR_NONE | WPS_ENCR_WEP | WPS_ENCR_TKIP | \
			WPS_ENCR_AES)
#define WPS_ENCR_TYPES_QTN (WPS_ENCR_NONE | WPS_ENCR_TKIP | WPS_ENCR_AES)
...
#define WPS_AP_PIN_LOCKOUT_TIME 2100 /* Incorrect PIN lockout time in seconds */
