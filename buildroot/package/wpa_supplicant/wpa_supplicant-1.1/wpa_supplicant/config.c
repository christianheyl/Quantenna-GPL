				...
				const char *value)
{
	...
	local_md5_convert_passphrase(temp, psk_md5);
...
int md5_sum(char *passphrase, int len, char *res_buf)
{
	int i;
	char *psk_use;
...
void wpa_config_update_psk(struct wpa_ssid *ssid)
{
	...
	local_md5_convert_passphrase(ssid->passphrase, passphrase_md5);
	ssid->passphrase_md5 = os_strdup(passphrase_md5);
	wpa_printf(MSG_DEBUG, "passphrase is %s, and passphrase_md5 is %s", ssid->passphrase, passphrase_md5);
