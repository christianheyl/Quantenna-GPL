 ...
 */
#define AUTOCONF_TIMESTAMP "2016-10-11 16:22:38 CST"
...
#define USE_MONOTONIC_SYSCALL(...) __VA_ARGS__
#define SKIP_MONOTONIC_SYSCALL(...)
...
#define USE_FEATURE_KILL_REMOVED(...) __VA_ARGS__
#define SKIP_FEATURE_KILL_REMOVED(...)
...
#define USE_FEATURE_UDHCP_8021Q(...)
#define SKIP_FEATURE_UDHCP_8021Q(...) __VA_ARGS__
