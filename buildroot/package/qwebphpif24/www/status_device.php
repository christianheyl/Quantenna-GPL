...
function read_mode24()
{
	...
	if($info == "0")
	{
		$res="<a style=\"font-weight:bold\">[X] Access Point</a>&nbsp;&nbsp;[&nbsp;] Bridge &nbsp;&nbsp;[&nbsp;] Repeater";
	}
	else if($info == "1")
	{
		$res="[&nbsp;] Access Point&nbsp;&nbsp;<a style=\"font-weight:bold\">[X] Bridge</a> &nbsp;&nbsp;[&nbsp;] Repeater";
	}
	else if ($info == "2")
	{
		$res="[&nbsp;] Access Point&nbsp;&nbsp;[&nbsp;] Bridge &nbsp;&nbsp;<a style=\"font-weight:bold\">[X] Repeater</a>";
	}
	else
	{$res="";}
	return $res;
