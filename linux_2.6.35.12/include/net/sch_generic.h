...
static inline struct sk_buff * __sram_text __qdisc_dequeue_head(struct Qdisc *sch,
						   struct sk_buff_head *list)
{
...
static inline struct sk_buff * __sram_text qdisc_dequeue_head(struct Qdisc *sch)
{
